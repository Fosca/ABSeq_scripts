...
for name in ['full_data_OpenedChunks_score_dict','full_data_ClosedChunks_score_dict','full_data_ChunkDepth_score_dict']:
    ...
    coucou = SVM_funcs.plot_gat_simple(anal_name, config.subjects_list, '/feature_decoding/'+name.replace('full_data_','').replace('_score_dict','')+'/R2', chance=0, score_field='score',
