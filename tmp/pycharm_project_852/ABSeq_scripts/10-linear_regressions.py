...
for filter_name in filter_names:
    ...
    config.noEEG = True
    regression_funcs.merge_individual_regression_results(reg_names, "", filter_name,suffix = '--remapped_baselined_clean' )
    # regression_funcs.regression_group_analysis(reg_names, "", filter_name, suffix='--remapped_mtgclean', Do3Dplot=False,suffix_evoked = '-remapped_mtgclean')
    regression_funcs.regression_group_analysis(reg_names, "", filter_name, suffix='--remapped_baselined_clean', Do3Dplot=False, suffix_evoked='-remapped_baselined_clean') # attention au bidule car il load tous les evoked
