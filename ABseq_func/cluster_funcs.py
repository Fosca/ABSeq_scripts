...
def linear_reg(subject):
    ...
    for filter_name in filter_names:
        ...
        regression_funcs.compute_regression(subject,['Complexity','WithinChunkPosition','RepeatAlter','ChunkBeginning', 'ChunkEnd', 'ChunkNumber', 'ChunkDepth'],"/Intercept_surprise_100_Surprisenp1_RepeatAlter_RepeatAlternp1/"+subject+"/residuals--remapped_clean-epo.fif",filter_name,remap_grads=False)
