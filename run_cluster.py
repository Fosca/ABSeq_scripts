...
cluster_funcs.create_qsub('SVM_2', 'svm2', 'svm2', queue='Global_long', sublist_subjects=['sub03-mr_190273'])
cluster_funcs.create_qsub('SVM_3', 'svm3', 'svm3', queue='Global_long', sublist_subjects=['sub03-mr_190273'])
